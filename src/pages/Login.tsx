    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: "center", marginBottom: "32px" }}>
          ...
          <p style={{ color: "#fff", fontWeight: 800, fontSize: "20px", margin: "0 0 4px" }}>PipelineIQ</p>
        ...
        <div style={{ display: "flex", gap: "16px", marginBottom: "28px", justifyContent: "center" }}>
          {[{ value: "142", label: "Pipelines" }, { value: "99.8%", label: "Uptime" }, { value: "<2s", label: "Latency" }].map(s => (
            <div key={s.label} style={{ textAlign: "center" }}>
              <p style={{ color: "#3b82f6", fontSize: "20px", fontWeight: 800, margin: "0 0 2px" }}>{s.value}</p>
        ...
        {error && <div style={{ background: "#ef444422", border: "1px solid #ef444444", borderRadius: "8px", padding: "10px 14px", color: "#ef4444", fontSize: "13px", marginBottom: "14px" }}>{error}</div>}
        ...
        <div style={{ marginTop: "16px", padding: "12px", background: "#0f1117", borderRadius: "10px", border: "1px solid #2a2f42", textAlign: "center" }}>
          <p style={{ color: "#6b7280", fontSize: "11px", margin: "0 0 4px", letterSpacing: "1px" }}>DEMO CREDENTIALS</p>
